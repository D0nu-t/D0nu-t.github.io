...
{ id: 'capgemini', label: 'Capgemini', type: 'work', category: 'work' },
  { id: 'geminae',       label: 'Project Geminae',                type: 'project', category: 'project' },
  { id:'cmu',        label:'CMU',        type:'academic', category:'academic'},
{ id:'midas',      label:'MIDAS Lab',  type:'academic', category:'academic'},
{ id:'iiitd',      label:'IIIT Delhi', type:'academic', category:'academic'},
  // Consulting / Industry
